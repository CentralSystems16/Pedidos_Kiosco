...
public class ContadorGastosCaja {
    ...
    public static class GetDataFromServerIntoTextView extends AsyncTask<Void, Void, Void> {
        ...
        String StringHolder = "" ;
        String contador_url = "http://"+ VariablesGlobales.host + "/android/kiosco/cliente/scripts/scripts_php/sumarGastos.php" + "?base=" + VariablesGlobales.dataBase + "&id_cierre_caja=" + CrearReporteCierreCaja.cierre + "&fac_tipo_movimiento=2";
        public static int totalCierreCaja = 0;
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                totalCierreCaja = (responseJSON.getJSONArray("voto").getJSONObject(0).getInt("count"));
