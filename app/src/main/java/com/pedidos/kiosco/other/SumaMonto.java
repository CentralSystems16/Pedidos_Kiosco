...
public class SumaMonto extends AsyncTask<Void, Void, Void>{
        ...
        public static String sumaMonto;
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                sumaMonto = String.valueOf((responseJSON.getJSONArray("voto").getJSONObject(0).getDouble("count")));
                System.out.println("Suma monto:" + sumaMonto);
