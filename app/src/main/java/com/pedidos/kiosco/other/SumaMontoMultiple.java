...
public class SumaMontoMultiple extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                sumaMontoMultiple = String.valueOf((responseJSON.getJSONArray("voto").getJSONObject(0).getDouble("count")));
